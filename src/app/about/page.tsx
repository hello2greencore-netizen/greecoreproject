...
export const metadata = buildMetadata({
  title: "About Us",
  description:
    "Green Core Heating & Air was founded to deliver a better experience for homeowners — thoughtful design, energy-efficient systems, and high-quality workmanship from start to finish.",
  path: "/about",
});
